...
All notable changes to X-UI Dashboard Monitor are documented in this file.

## [1.0.0] - 2024-12-01

### 🎉 Initial Release

This is the first stable release of X-UI Dashboard Monitor with comprehensive features for managing multiple X-UI VPN panels.
